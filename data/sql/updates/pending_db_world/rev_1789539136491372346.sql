...
ALTER TABLE `creature` ADD COLUMN IF NOT EXISTS `PhaseId` int unsigned NOT NULL DEFAULT '0' AFTER `phaseMask`;
ALTER TABLE `gameobject` ADD COLUMN IF NOT EXISTS `PhaseId` int unsigned NOT NULL DEFAULT '0' AFTER `phaseMask`;
