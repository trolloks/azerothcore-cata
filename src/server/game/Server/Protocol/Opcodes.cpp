...
#define DEFINE_BIDIRECTIONAL_OPCODE(opcode, clientOpcode, serverOpcode) \
    ...
    /*0x0D46*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_ADDON_BATTLEGROUND,                                   STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleAddonMessagechatOpcode              );
    /*0x0544*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_ADDON_GUILD,                                          STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleAddonMessagechatOpcode              );
    /*0x3954*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_ADDON_OFFICER,                                        STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleAddonMessagechatOpcode              );
    /*0x0546*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_ADDON_PARTY,                                          STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleAddonMessagechatOpcode              );
    /*0x1D56*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_ADDON_RAID,                                           STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleAddonMessagechatOpcode              );
    /*0x2146*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_ADDON_WHISPER,                                        STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleAddonMessagechatOpcode              );
    /*0x0D44*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_AFK,                                                  STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleMessagechatOpcode                  );
    /*0x2156*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_BATTLEGROUND,                                         STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleMessagechatOpcode                  );
    /*0x1D44*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_CHANNEL,                                              STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleMessagechatOpcode                  );
    /*0x2946*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_DND,                                                  STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleMessagechatOpcode                  );
    /*0x1156*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_EMOTE,                                                STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleMessagechatOpcode                  );
    /*0x3956*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_GUILD,                                                STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleMessagechatOpcode                  );
    /*0x1946*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_OFFICER,                                              STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleMessagechatOpcode                  );
    /*0x1D46*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_PARTY,                                                STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleMessagechatOpcode                  );
    /*0x2D44*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_RAID,                                                 STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleMessagechatOpcode                  );
    /*0x0944*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_RAID_WARNING,                                         STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleMessagechatOpcode                  );
    /*0x1154*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_SAY,                                                  STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleMessagechatOpcode                  );
    /*0x0D56*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_WHISPER,                                              STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleMessagechatOpcode                  );
    /*0x3544*/ DEFINE_HANDLER(CMSG_MESSAGECHAT_YELL,                                                 STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleMessagechatOpcode                  );
    ...
    /*0x0926*/ DEFINE_HANDLER(CMSG_ATTACKSWING,                                                      STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleAttackSwingOpcode                  );
    /*0x4106*/ DEFINE_HANDLER(CMSG_ATTACKSTOP,                                                       STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleAttackStopOpcode                   );
    /*0x2D15*/ DEFINE_SERVER_OPCODE_HANDLER(SMSG_ATTACKSTART,                                        STATUS_NEVER);
    /*0x0934*/ DEFINE_SERVER_OPCODE_HANDLER(SMSG_ATTACKSTOP,                                         STATUS_NEVER);
    ...
    /*0x0B25*/ DEFINE_SERVER_OPCODE_HANDLER(SMSG_ATTACKERSTATEUPDATE,                                STATUS_NEVER);
