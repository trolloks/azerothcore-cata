...
enum OpcodeClient : uint16
{
    ...
    CMSG_CHEAT_SETMONEY                             = 0x024, // DEPRECATED
    CMSG_LEVEL_CHEAT                                = 0x025, // DEPRECATED
    CMSG_PET_LEVEL_CHEAT                            = 0x026, // DEPRECATED
    ...
    CMSG_AUTH_SRP6_PROOF                            = 0x034, // DEPRECATED
...
enum OpcodeServer : uint16
{
    ...
    SMSG_INSTANCE_DIFFICULTY                        = 0x31A2,
    SMSG_MOTD                                       = 0x0A35,
